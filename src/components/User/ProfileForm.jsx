...
import ProfileSkeleton from '../../ProductSkeleton/ProfileSkeleton.jsx'
    ...
    if (ProfileDetails === null || ProfileDetails.length === 0) {
        ...
        return (
            ...
            <div className="card p-5 rounded-3">
                <h4 style={{color:"#c8a705"}}> <b> Customer details</b></h4>
                <hr/>
                ...
                <h4 style={{color:"#c8a705"}}> <b> Shipping Details</b></h4>
                <hr/>
                <div className="row">
                    <div className="col-md-3 p-2">
                ...
                <div className="row mt-4">
                    <div className="col-md-3 p-2">
                        <button style={{background:"#d79706", border: 'none', }} onClick={Save} className="btn btn-success">Save</button>
                    </div>
                </div>
